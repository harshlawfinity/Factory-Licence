  ...
  return (
    <div className="bg-gradient-to-bc text-gray-800 ">
      ...
      <section className="bg-white py-14 px-6">
        <h2 className="text-3xl font-semibold mb-6 text-center">About Factorylicence.in</h2>
        <p className="max-w-4xl mx-auto text-justify text-gray-700 leading-relaxed">
          Factorylicence.in is your most trusted partner for all the services spanning from factory setup to factory management. Services like taking care of factory compliance, factory licensing etc. We provide a comprehensive and tailored support to make sure that your business journey remains smooth and shiny.
          <br /><br />
